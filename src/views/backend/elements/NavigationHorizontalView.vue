...
<template>
  <!-- Hero -->
  <BasePageHeading title="Horizontal Navigation"
  ...
  <div class="content">
    ...
    <div class="bg-sidebar-dark p-3 push">
      <!-- Toggle Navigation -->
      <div class="d-lg-none">
        <button type="button" class="btn w-100 btn-secondary d-flex justify-content-between align-items-center" @click="
    ...
    <div class="bg-sidebar-dark p-3 push">
      ...
      <div class="d-lg-block mt-2 mt-lg-0" :class="{
        ...
        <BaseNavigation :nodes="menu.demo" dark horizontal horizontal-hover horizontal-center></BaseNavigation>
      </div>
      <!-- END Navigation -->
    </div>
    ...
    <div class="bg-white p-3 push">
      ...
      <div class="d-lg-block mt-2 mt-lg-0" :class="{
        ...
        <BaseNavigation :nodes="menu.demo" horizontal horizontal-hover horizontal-justify />
      </div>
      <!-- END Navigation -->
    </div>
    ...
    <div class="bg-sidebar-dark p-3 push">
      ...
      <div class="d-lg-block mt-2 mt-lg-0" :class="{
        ...
        <BaseNavigation :nodes="menu.demo" dark horizontal horizontal-hover horizontal-justify />
      </div>
      <!-- END Navigation -->
    </div>
