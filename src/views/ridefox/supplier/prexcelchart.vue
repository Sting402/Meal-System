...
import FlatPickr from "../../../components/Prexcelchart/FlatPickr.vue";
import PR from '../../../components/Prexcelchart/MultipleSelectPR .vue';
// Flatpickr variables
...
const openExcelFile = () => {
    ...
    a.href = "/static/PR Excel.xlsx"; // 给a标签的href属性值加上地址，注意，这里是绝对路径，不用加 点.
    a.download = "PR Excel.xlsx"; //设置下载文件文件名，这里加上.xlsx指定文件类型，pdf文件就指定.fpd即可
...
<template>
    <BasePageHeading title="PR Excel分帳報表" subtitle="分帳報表">
        <template #extra>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">PR Excel分帳報表</li>
                </ol>
            </nav>
        </template>
    </BasePageHeading>
    <div class="content">
        <BaseBlock title="PR Excel" :rounded="true" header-class="bg-muted" themed>
            <div class="row items-push text-center">
                <div class="col-sm-6 col-xl-4 col-md-4">
                    <label class="form-label" for="example-select">PR分帳</label>
                    <PR></PR>
                </div>
                <div class="col-sm-6 col-xl-4 col-md-4">
