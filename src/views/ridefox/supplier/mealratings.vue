...
import Supplier from '../../../components/Mealratings/MultipleSelectSupplier.vue';
import Pro from '../../../components/Mealratings/MultipleSelectPro.vue';
import Meal from '../../../components/Mealratings/MultipleSelectMeal.vue';
import Type from '../../../components/Mealratings/MultipleSelectType.vue';
// Flatpickr variables
...
const openExcelFile = () => {
    ...
    a.href = "/static/餐點評分報表.xlsx"; // 给a标签的href属性值加上地址，注意，这里是绝对路径，不用加 点.
    a.download = "餐點評分報表.xlsx"; //设置下载文件文件名，这里加上.xlsx指定文件类型，pdf文件就指定.fpd即可
...
<template>
    <BasePageHeading title="餐點評分報表" subtitle="查看已評分之餐點">
        <template #extra>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">餐點評分報表</li>
                </ol>
            </nav>
        </template>
    </BasePageHeading>
    <div class="content">
        <BaseBlock title="餐點評分" :rounded="true" header-class="bg-muted" themed>
