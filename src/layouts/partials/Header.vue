...
let list = JSON.parse(localStorage.getItem('loginInfo'))
//console.log(list);
//目前還沒解決
if (list === null) {
  console.log(111);
            ...
            <div class="dropdown d-inline-block ms-2">
              <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center"
                ...
                <img class="rounded-circle" src="/assets/media/avatars/avatar10.jpg" alt="Header Avatar"
                  style="width: 21px" />
                <span class="d-none d-sm-inline-block ms-2">{{ list.e_Name }}</span>
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                ...
                <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="/assets/media/avatars/avatar10.jpg"
                    alt="Header Avatar" />
                  <p class="mt-2 mb-0 fw-medium">{{ list.e_Name }}</p>
                  <p class="mb-0 text-muted fs-sm fw-medium">{{ list.c_Name }}</p>
                </div>
                <!-- <div class="p-2">
